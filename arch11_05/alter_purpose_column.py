...
def alter_column_type():
    """Изменяет тип колонки Unnamed: 26 с integer на text"""
    try:
        ...
        with conn.cursor() as cursor:
            ...
            ALTER COLUMN "Unnamed: 26" TYPE text USING "Unnamed: 26"::text;
            """
            
            # Выполняем запрос
            cursor.execute(sql)
            
            logger.info("Тип колонки Unnamed: 26 успешно изменен на text")
