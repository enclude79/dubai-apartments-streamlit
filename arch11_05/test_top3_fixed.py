...
async def test_top3_properties():
    """Тестирование запроса на топ-3 квартиры для каждого района после исправления кодировки"""
    try:
        print("=" * 80)
        print("ТЕСТИРОВАНИЕ ЗАПРОСА ТОП-3 КВАРТИР ПО РАЙОНАМ (ИСПРАВЛЕННАЯ КОДИРОВКА)")
        print("=" * 80)
        ...
        print("\n" + "=" * 80)
        print("ТЕСТ 1: Прямой вызов метода get_latest_property_by_region")
        print("=" * 80)
        ...
        print("\n" + "=" * 80)
        print("ТЕСТ 2: Вызов через вопрос пользователя")
        print("=" * 80)
        ...
        print("\n" + "=" * 80)
        print("ТЕСТ 3: Другая формулировка вопроса")
        print("=" * 80)
...
if __name__ == "__main__":
    success = asyncio.run(test_top3_properties())
    if success:
